...
\begin{figure}[!h]\centering
  \input{./figures/parts/02/chapters/04/sections/02/exec_times_all_rotations_default.tex}
...
σύμπτωση της εκτίμησης θέσης με την πραγματική θέση. Το αριστερό γράφημα του
...
\begin{remark}
  ...
  δειγματολειψίας στη γενική συνθήκη όπου ο χάρτης του περιβάλλοντος δεν το
