...
\begin{figure}[!h]\centering
  \input{./figures/parts/02/chapters/04/sections/02/times_rc_fm.tex}
...
\begin{figure}[!h]\centering
  \vspace{0.5cm}
  \input{./figures/parts/02/chapters/04/sections/02/phi_rc_x1.tex}
  \vspace{1.0cm}
...
\begin{figure}[!h]\centering
  \input{./figures/parts/02/chapters/04/sections/02/times_rc_x1.tex}
  \caption{\small Ο μέσος χρόνος εκτέλεσης μίας επανάληψης της μεθόδου
...
\begin{figure}[!h]\centering
  \input{./figures/parts/02/chapters/04/sections/02/times_rc_uf.tex}
  \caption{\small Ο μέσος χρόνος εκτέλεσης μίας επανάληψης της μεθόδου
...
\begin{figure}[!h]\centering
  \input{./figures/parts/02/chapters/04/sections/02/times_rc_fm_DBH.tex}
...
σε εκατό επαναλήψεις πειραμάτων με ένα σύνολο δεδομένων $778$ περιβαλλόντων και
χαρτών. Στο αριστερό σχήμα ο χάρτης αναπαριστά στην εντέλεια το περιβάλλον, σε
αντίθεση με το δεξιό σχήμα, στο οποίο ο χάρτης είναι διεφθαρμένος.
...
Έπειτα, οι μέθοδοι διακριτού χώρου Fourier-Mellin και Προκρούστη, με και δίχως
τη χρήση της μεθόδου του Θησέα, επηρεάζονται από διαφορετικά προβλήματα που
αναδύονται στη γενική περίπτωση, η οποία αφορά στη γενική συνθήκη όπου η
εκτίμηση θέσης δεν συμπέφτει ακριβώς με την πραγματική θέση. Όσο αφορά στην
πρώτη περίπτωση, το σφάλμα εκτίμησης προσανατολισμού δεν είναι δυνατό να
μειωθεί κάτω από $\gamma/2$ σε ένα βήμα λόγω του γεγονότος ότι από διαφορετικές
θέσεις είναι ορατά διαφορετικά σημεία του περιβάλλοντος και του χάρτη, με
συνέπεια μεγαλύτερη αναντιστοιχία μεταξύ των σαρώσεων εισόδου. Στη δεύτερη
περίπτωση, όταν δηλαδή χρησιμοποιείται η μέθοδος του Θησέα για την περαιτέρω
μείωση του σφάλματος προσανατολισμού, το αναδυόμενο πρόβλημα είναι μεγαλύτερης
βαρύτητας διότι η μη σύμπτωση των δύο θέσεων διαταράσσει την ευθεία αντιστοιχία
ανάμεσα στα αύξοντα Ποσοστά Διάκρισης των σφαλμάτων προσανατολισμού και τα
φθίνοντα μέτρα τους. Με άλλα λόγια, στη γενική περίπτωση, όπου η εκτίμηση θέσης
δεν ισούται με την πραγματική θέση, το υψηλότερο Ποσοστό Διάκρισης δεν
αντιστοιχεί στο ελάχιστο σφάλμα προσανατολισμού. Αυτά τα δύο προβλήματα
εκτίθενται στο σχήμα \ref{fig:02_04_02:theseus_false_pd}.

\begin{figure}[!h]\centering
  \begin{subfigure}{\linewidth}
    \vspace{2cm}
    \input{./figures/parts/02/chapters/04/sections/04/fmt_non_convergence.tex}
  \end{subfigure}\\ \vspace{1cm}\hspace{-1cm}
  \begin{subfigure}{0.30\linewidth}\vspace{2.68cm}
    \begin{onion}{0.7cm}
      \annulus[sinisn0]{0}{0}{360}[$\phi^{(0)}$]
      \annulus[sinisn0]{1}{0}{180}[$\phi_0^{(1)}$]
      \annulus[sinisn1]{1}{180}{360}[$\phi_1^{(1)}$]
      \annulus[sinisn2]{2}{180}{225}[$\phi_0^{(2)}$]
      \annulus[sinisn0]{2}{225}{270}[$\phi_1^{(2)}$]
      \annulus[sinisn0]{2}{270}{315}[$\phi_2^{(2)}$]
      \annulus[sinisn0]{2}{315}{360}[$\phi_3^{(2)}$]
      \annulus[sinisn3]{3}{180}{185.625}
      \annulus[sinisn0]{3}{185.625}{191.25}
      \annulus[sinisn0]{3}{191.25}{196.875}
      \annulus[sinisn0]{3}{196.875}{202.5}
  ...
  \begin{subfigure}{0.30\linewidth}
    \begin{onion}{0.7cm}
      \annulus[sinisn0]{0}{0}{360}[$\phi^{\prime (0)}$]
      \annulus[sinisn1]{1}{0}{180}[$\phi_0^{\prime (1)}$]
      \annulus[sinisn0]{1}{180}{360}[$\phi_1^{\prime (1)}$]
      \annulus[sinisn0]{2}{0}{45}[$\phi_0^{\prime (2)}$]
      \annulus[sinisn0]{2}{45}{90}[$\phi_1^{\prime (2)}$]
      \annulus[sinisn0]{2}{90}{135}[$\phi_2^{\prime (2)}$]
      \annulus[sinisn2]{2}{135}{180}[$\phi_3^{\prime (2)}$]
      \annulus[sinisn0]{3}{45}{50.625}
      \annulus[sinisn0]{3}{50.625}{56.25}
      \annulus[sinisn0]{3}{56.25}{61.875}
      \annulus[sinisn0]{3}{61.875}{67.5}
      \annulus[sinisn3]{3}{67.5}{73.125}
      \annulus[sinisn0]{3}{73.125}{78.75}
      \annulus[sinisn0]{3}{78.75}{84.375}
      \annulus[sinisn0]{3}{84.375}{90}
    \end{onion}
  \end{subfigure}%
  \begin{subfigure}{0.30\linewidth}
    \begin{onion}{0.7cm}
      \annulus[sinisn0]{0}{0}{360}[PD$^{\prime (0)}$]
      \annulus[litegray]{1}{0}{180}[PD$_0^{\prime (1)}$]
      \annulus[sinisn0]{1}{180}{360}[PD$_1^{\prime (1)}$]
      \annulus[sinisn0]{2}{0}{45}[PD$_0^{\prime (2)}$]
      \annulus[litegray]{2}{45}{90}[PD$_1^{\prime (2)}$]
      \annulus[sinisn0]{2}{90}{135}[PD$_2^{\prime (2)}$]
      \annulus[sinisn0]{2}{135}{180}[PD$_3^{\prime (2)}$]
      \annulus[sinisn0]{3}{45}{50.625}
      \annulus[sinisn0]{3}{50.625}{56.25}
      \annulus[sinisn0]{3}{56.25}{61.875}
      \annulus[sinisn0]{3}{61.875}{67.5}
  ...
  \end{subfigure}
\vspace{-1cm}
\caption{Στην άνω σειρά διενεργούμε το ίδιο πείραμα με αυτό του σχήματος
         \ref{fig:02_04_02:theseus} για την ίδια εκτίμηση στάσης, μετατοπισμένη
         όμως κατά $-0.12$ m στον οριζόντιο άξονα. Στο δεξιό γράφημα της άνω
         σειράς παρατηρούμε πως σε αυτή την περίπτωση το μέτρο του σφάλματος
         εκτίμησης προσανατολισμού δεν ήταν δυνατό να μειωθεί λιγότερο από
         $\gamma/2$ στο τέλος της πρώτης επανάληψης. Στην κάτω σειρά: στα
         αριστερά παρατίθεται η βέλτιστη πορεία κατάτμησης του αρχικού
         επίλοιπου σφάλματος (σχήμα \ref{fig:02_04_02:theseus_pd}), στη μέση η
         κατάτμηση των επίλοιπων σφάλματων προσανατολισμού ανά βαθμό
         δειγματοληψίας $\nu$ με βάση τη μέθοδο του Θησέα σε αυτό το πείραμα,
         και με χρώμα τα πραγματικά ελάχιστα σφάλματα, και στα δεξιά με γκρι τα
         αντιστοιχούντα μέγιστα ποσοστά διάκρισης ανά βαθμό δειγματοληψίας.
         Παρατηρήστε πως πλέον δεν υφίσταται ευθεία αντιστοιχία του μέγιστου
         ποσοστού διάκρισης με το ελάχιστο επίλοιπο σφάλμα προσανατολισμού}
...
\begin{itemize}
  \item Στη μεν μέθοδο Πρώτων Αρχών είναι αδόκιμη η εφαρμογή μεθόδου
        υπερδειγματολειψίας του χάρτη και εσωτερικής ιεράρχησης των σφαλμάτων
        προσανατολισμού---σε αντιστοιχία με τη μέθοδο του Θησέα---για την
        περαιτέρω μείωση του σφάλματος προσανατολισμού λόγω της συνεχούς φύσεώς
        της. Επιπρόσθετα, ακόμα και να ήταν δυνατή η εφαρμογή τέτοιας μεθόδου,
        η μη φθίνουσα σχέση του σφάλματος εκτίμησης προσανατολισμού με τον
        αύξοντα βαθμό δειγματολειψίας στη γενική συνθήκη όπου ο χάρτης του
        περιβάλλοντος δεν το αναπαριστά τέλεια θα καθιστούσε οποιαδήποτε
        εσωτερική σύγκριση αδιάφορη.
  \item Στις δε Προκρούστειες μεθόδους με εφαρμογή της μεθόδου του Θησέα η
        εσωτερική σύγκριση μεταξύ των τιμών της μετρικής του Ποσοστού Διάκρισης
        οδηγεί σε μη βέλτιστα σφάλματα προσανατολισμού, ακόμα και όταν ο χάρτης
        αναπαριστά το περιβάλλον τέλεια και ο αισθητήρας σαρώσεων δεν
        επηρεάζεται από διαταραχές.
\end{itemize}


Λόγω των παραπάνω είναι αναγκαία η εφεύρεση επιπρόσθετων μεθόδων, και εξωτερικών
ως προς τις παραπάνω προσεγγίσεις, για τη σύγκλιση στο βέλτιστο κατά περίπτωση
