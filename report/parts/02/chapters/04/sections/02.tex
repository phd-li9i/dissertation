...
$\mathcal{F}_1\{\mathcal{S}\}$ ο πρώτος όρος του μετασχηματισμού (υποθέτωντας
...
επανάληψης της μεθόδου σε δεκα εκτελέσεις για μεταβλητό μέγεθος σαρώσεων $N_s$.
...
μίας επανάληψης της μεθόδου σε δεκα εκτελέσεις για μεταβλητό μέγεθος σαρώσεων
...
\begin{figure}[h]\centering
  ...
  \caption{\small Ο μέσος χρόνος εκτέλεσης μίας επανάληψης της μεθόδου
           Πρώτων Αρχών για δέκα εκτελέσεις ανά μέγεθος σαρώσεων $N_s$}
...
\begin{figure}[h]\centering
  ...
  \caption{\small Ο μέσος χρόνος εκτέλεσης μίας επανάληψης της μεθόδου
           Προκρούστη διάστασης για δέκα εκτελέσεις ανά μέγεθος σαρώσεων $N_s$}
