...
\begin{figure}\centering
  \begin{subfigure}{0.4\linewidth}
    \dirtree{%
    .1 $\hat{\theta}^{[0]}   =$  \textcolor{k}{7.8640e-03}.
    .2 $\hat{\theta}_0^{[1]} =$  \textcolor{mygray}{7.8640e-03}.
    .2 $\hat{\theta}_1^{[1]} =$  \textcolor{k}{8.5600e-04}.
    .3 $\hat{\theta}_1^{[2]} =$  \textcolor{k}{8.5600e-04}.
    .4 $\hat{\theta}_0^{[3]} =$  \textcolor{k}{8.5600e-04}.
    .4 $\hat{\theta}_1^{[3]} =$  \textcolor{mygray}{3.0460e-03}.
    .4 $\hat{\theta}_2^{[3]} =$  \textcolor{mygray}{5.2260e-03}.
    .4 $\hat{\theta}_3^{[3]} =$  \textcolor{mygray}{7.4060e-03}.
    .4 $\hat{\theta}_4^{[3]} =$  \textcolor{mygray}{7.8640e-03}.
    .4 $\hat{\theta}_5^{[3]} =$  \textcolor{mygray}{5.6840e-03}.
    .4 $\hat{\theta}_6^{[3]} =$  \textcolor{mygray}{3.5040e-03}.
    .4 $\hat{\theta}_7^{[3]} =$  \textcolor{mygray}{1.3240e-03}.
    .3 $\hat{\theta}_1^{[2]} =$  \textcolor{mygray}{5.2260e-03}.
    .3 $\hat{\theta}_2^{[2]} =$  \textcolor{mygray}{7.8640e-03}.
    .3 $\hat{\theta}_3^{[2]} =$  \textcolor{mygray}{3.5040e-03}.
    }
  \end{subfigure}%
  \begin{subfigure}{0.4\linewidth}
    \dirtree{%
    ...
    .2 $\text{PD}_1^{[1]} =$ \textcolor{k}{0.99986}.
    .3 $\text{PD}_1^{[2]} =$ \textcolor{k}{0.99986}.
    .4 $\text{PD}_0^{[3]} =$ \textcolor{k}{0.99986}.
