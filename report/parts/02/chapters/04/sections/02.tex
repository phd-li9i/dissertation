...
τέλεια, ενώ οι μετρήσεις του αισθητήρα δεν διαταράσσονται από θόρυβο. Ο
αλγόριθμος \ref{alg:algorithm_fmrc} παρουσιάζει σε ψευδοκώδικα τη διαδικασία
...
\begin{remark}
  ...
  οδηγεί σε ένα επίλοιπο σφάλμα προσανατολισμού $\phi$:
  \begin{align}
    %\phi &= \tan^{-1}\dfrac{N_s \delta_x \tan(\theta - \angle \mathcal{F}_1\{\mathcal{S}_R\}) - N_s \delta_y}{|\mathcal{F}_1\{\mathcal{S}_R\}| + N_s \delta_x + N_s \delta_y \tan(\theta - \angle \mathcal{F}_1\{\mathcal{S}_R\})} \label{eq:phi2}
  ...
  \end{align}
  όπου $\delta = \delta_x - i \cdot \delta_y$. Το μέτρο του σφάλματος $|\phi|$
  είναι αντιστρόφως ανάλογο του αριθμού των ακτίνων $N_s$ που
...
παρουσιάζονται στο σχήμα \ref{fig:02_04_02:rc_fm}. Ο αλγόριθμος
