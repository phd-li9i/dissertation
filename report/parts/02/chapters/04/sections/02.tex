...
\begin{remark}
  ...
  οι σαρώσεις $\mathcal{S}_R$ και $\mathcal{S}_V$ είναι $\Delta\theta$, τότε
  $\Delta\theta = \xi\gamma + \phi$, όπου
  $\mod(\Delta\theta, \gamma) = \phi \in [-\dfrac{\gamma}{2},+\dfrac{\gamma}{2}]$.
  Επομένως, για δεδομένο αριθμό εκπεμπόμενων ακτίνων $N_s$ (ισοδύναμα, για
  δεδομένη διακριτική γωνία $\gamma$), ενημερώνοντας την εκτίμηση
  προσανατολισμού σε $\hat{\theta}^\prime$:
  \begin{align}
...
\begin{remark}
  ...
  $\Delta\theta = (N_s-1-J)\gamma + \phi$, όπου
  $\mod(\Delta\theta, \gamma) = \phi \in [-\dfrac{\gamma}{2},+\dfrac{\gamma}{2}]$.
  Επομένως, για δεδομένο αριθμό εκπεμπόμενων ακτίνων $N_s$ (ισοδύναμα, για
  δεδομένη διακριτική γωνία $\gamma$), ενημερώνοντας την εκτίμηση
  προσανατολισμού σε $\hat{\theta}^\prime$:
...
\begin{figure}\centering
  \begin{subfigure}{0.5\linewidth}
    ...
    \dirtree{%
    .1 $|\theta-\hat{\theta}^{[0]}| / \dfrac{\gamma}{2^0}  =$  \textcolor{k}{0.45} $< 2^{-1}$.
    .2 $|\theta-\hat{\theta}_0^{[1]}| / \dfrac{\gamma}{2^1}=$  \textcolor{mygray}{0.45}.
    .2 $|\theta-\hat{\theta}_1^{[1]}| / \dfrac{\gamma}{2^1}=$  \textcolor{k}{0.22} $< 2^{-1}$.
    .3 $|\theta-\hat{\theta}_0^{[2]}| / \dfrac{\gamma}{2^2}=$  \textcolor{k}{0.19} $< 2^{-1}$.
    .4 $|\theta-\hat{\theta}_0^{[3]}| / \dfrac{\gamma}{2^3}=$  \textcolor{k}{0.39} $< 2^{-1}$.
    .4 $|\theta-\hat{\theta}_1^{[3]}| / \dfrac{\gamma}{2^3}=$  \textcolor{mygray}{1.39}.
    .4 $|\theta-\hat{\theta}_2^{[3]}| / \dfrac{\gamma}{2^3}=$  \textcolor{mygray}{2.39}.
    .4 $|\theta-\hat{\theta}_3^{[3]}| / \dfrac{\gamma}{2^3}=$  \textcolor{mygray}{3.39}.
    .4 $|\theta-\hat{\theta}_4^{[3]}| / \dfrac{\gamma}{2^3}=$  \textcolor{mygray}{3.60}.
    .4 $|\theta-\hat{\theta}_5^{[3]}| / \dfrac{\gamma}{2^3}=$  \textcolor{mygray}{2.60}.
    .4 $|\theta-\hat{\theta}_6^{[3]}| / \dfrac{\gamma}{2^3}=$  \textcolor{mygray}{1.60}.
    .4 $|\theta-\hat{\theta}_7^{[3]}| / \dfrac{\gamma}{2^3}=$  \textcolor{mygray}{0.60}.
    .3 $|\theta-\hat{\theta}_1^{[2]}| / \dfrac{\gamma}{2^2}=$  \textcolor{mygray}{1.195}.
    .3 $|\theta-\hat{\theta}_2^{[2]}| / \dfrac{\gamma}{2^2}=$  \textcolor{mygray}{1.80}.
    .3 $|\theta-\hat{\theta}_3^{[2]}| / \dfrac{\gamma}{2^2}=$  \textcolor{mygray}{0.80}.
    }
  \end{subfigure}%
  ...
  \begin{subfigure}{0.5\linewidth}
  \begin{onion}{1.0cm}
    \annulus[sinisn0]{0}{0}{360}[$\hat{\theta}$]
    \annulus[sinisn1]{1}{0}{180}[$\hat{\theta}_0^{[1]}$]
    \annulus[sinisn1]{1}{180}{360}[$\hat{\theta}_1^{[1]}$]
    \annulus[sinisn2]{2}{180}{225}[$\hat{\theta}_0^{[2]}$]
    \annulus[sinisn2]{2}{225}{270}[$\hat{\theta}_1^{[2]}$]
    \annulus[sinisn2]{2}{270}{315}[$\hat{\theta}_2^{[2]}$]
    \annulus[sinisn2]{2}{315}{360}[$\hat{\theta}_3^{[2]}$]
  ...
  \begin{onion}{1.0cm}
    ...
    \annulus[sinisn1]{1}{180}{360}[PD$_1^{[1]}$]
    \annulus[sinisn2]{2}{180}{225}[PD$_0^{[2]}$]
