...
\begin{picture}(5000.00,5000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(2587,4844){\makebox(0,0){\strut{}\small Σφάλμα εκτίμησης προσανατολισμού [rad] ως προς $\nu_{\max}$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.15,0.15,0.15}%
    ...
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.00,0.00,0.00}%
      \put(2587,3268){\makebox(0,0){\strut{}\small Σφάλμα εκτίμησης θέσης [m] ως προς $\nu_{\max}$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.15,0.15,0.15}%
    ...
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.00,0.00,0.00}%
      \put(2587,1692){\makebox(0,0){\strut{}\small Χρόνος εκτέλεσης [ms] ως προς $\nu_{\max}$}}%
    }%
