...
\begin{picture}(8000.00,4000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(5900,4700){\makebox(0,0){\strut{}{\color{k}{\rule[0.6mm]{0.5cm}{0.5mm}}} $\dfrac{|\theta-\hat{\theta}[k]|}{\gamma}$}}%
      \put(5400,4219){\makebox(0,0){\strut{}{\color{g}{\rule[0.6mm]{0.5cm}{0.5mm}}} $2^{-1}$}}%
      \put(6400,4219){\makebox(0,0){\strut{}{\color{m}{\rule[0.6mm]{0.5cm}{0.5mm}}} $2^{-4}$}}%
      ...
      \put(3600,3919){\makebox(0,0){\strut{}{\color{svf}{\rule[0.6mm]{0.5cm}{0.5mm}}} $\hat{\bm{p}}[4]$}}%
      ...
      \put(2300,-250){\makebox(0,0){\strut{} Προκρούστειες Μέθοδοι}}%

      \put(5899,-250){\makebox(0,0){\strut{}Αριθμός επαναλήψεων $k$}}%
    }
    \gplgaddtomacro\gplfronttext{%
    }%
    \put(0,0){\includegraphics{./figures/parts/02/chapters/04/sections/04/fmt_non_convergence}}%
    \gplfronttext
  \end{picture}%
\endgroup
