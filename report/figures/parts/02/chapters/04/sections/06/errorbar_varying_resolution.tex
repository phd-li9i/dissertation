...
\begin{picture}(5000.00,8000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(2587,7619){\makebox(0,0){\strut{}Μέσο σφάλμα εκτίμησης προσανατολισμού συναρτήσει $\mu_{\max}$ [rad]}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    ...
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.00,0.00,0.00}%
      \put(2587,5161){\makebox(0,0){\strut{}Μέσο σφάλμα εκτίμησης θέσης συναρτήσει $\mu_{\max}$ [m]}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{1.00,0.00,0.00}%
    ...
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.00,0.00,0.00}%
      \put(2587,2704){\makebox(0,0){\strut{}Μέσος ολικός χρόνος εκτέλεσης συναρτήσει $\mu_{\max}$ [ms]}}%
      \put(2587,250){\makebox(0,0){\strut{}\small $\mu_{\max}: (\mu_{\min},\mu_{\max}) = (2^0,2^{\nu_{\max}})$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{1.00,0.00,0.00}%
