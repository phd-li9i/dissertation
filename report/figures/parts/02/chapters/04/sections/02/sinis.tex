...
\begin{picture}(8000.00,8000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.15,0.15,0.15}%
      \put(5257,4180){\makebox(0,0){\strut{}$3$}}%
      \colorrgb{0.15,0.15,0.15}%
      \put(6285,4180){\makebox(0,0){\strut{}$15$}}%
      \colorrgb{0.15,0.15,0.15}%
      \put(6542,4180){\makebox(0,0){\strut{}$18$}}%
      \colorrgb{0.15,0.15,0.15}%
      \put(6799,4180){\makebox(0,0){\strut{}$21$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.15,0.15,0.15}%
      \put(5216,580){\makebox(0,0){\strut{}$3$}}%
      \colorrgb{0.15,0.15,0.15}%
      \put(5648,580){\makebox(0,0){\strut{}$9$}}%
      \colorrgb{0.15,0.15,0.15}%
      \put(6223,580){\makebox(0,0){\strut{}$17$}}%
      \colorrgb{0.15,0.15,0.15}%
      \put(6799,580){\makebox(0,0){\strut{}$25$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.15,0.15,0.15}%

      \put(5400,7519){\makebox(0,0){\strut{}{\color{k}{\rule[0.6mm]{0.5cm}{0.5mm}}} $\dfrac{|\theta-\hat{\theta}[k]|}{\gamma}$}}%
      \put(6800,7519){\makebox(0,0){\strut{}{\color{g}{\rule[0.6mm]{0.5cm}{0.5mm}}} $2^{-1}$}}%
    ...
    \put(0,0){\includegraphics{./figures/parts/02/chapters/04/sections/02/sinis}}%
    \gplfronttext
  \end{picture}%
\endgroup
