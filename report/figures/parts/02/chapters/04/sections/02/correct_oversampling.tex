...
\begin{picture}(5000.00,5000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      %\put(1339,3945){\makebox(0,0)[l]{\color{BL}\strut{}\small $\texttt{PD}^{(2)}_0$$<\texttt{PD}^{(2)}_3$}}%
      \put(1339,3945){\makebox(0,0)[l]{\color{BL}\strut{}\small $\texttt{PD}_0$$<\texttt{PD}_3$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
      ...
      %\put(3789,3945){\makebox(0,0)[l]{\color{OR}\strut{}\small $\texttt{PD}^{(2)}_1$$<\texttt{PD}^{(2)}_2$}}%
      \put(3789,3945){\makebox(0,0)[l]{\color{OR}\strut{}\small $\texttt{PD}_1$$<\texttt{PD}_2$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
      ...
      %\put(1339,1495){\makebox(0,0)[l]{\color{GR}\small \strut{}$\texttt{PD}^{(2)}_2$$<\texttt{PD}^{(2)}_0$}}%
      \put(1339,1495){\makebox(0,0)[l]{\color{GR}\small \strut{}$\texttt{PD}_2$$<\texttt{PD}_0$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(3829,1495){\makebox(0,0)[l]{\color{PU}\small \strut{}$\texttt{PD}_3$}}%
    }%
    \put(0,0){\includegraphics{./figures/parts/02/chapters/04/sections/02/correct_oversampling}}%
    \gplfronttext
  \end{picture}%
\endgroup
