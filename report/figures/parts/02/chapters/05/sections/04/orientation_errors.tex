...
\begin{picture}(8000.00,12000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.00,0.00,0.00}%
      \put(4139,7019){\makebox(0,0){\strut{}\scriptsize $(\overline{\delta}_{xy}, \overline{\delta}_\theta) = (0.20 \ \text{m}, 0.3 \ \text{rad})$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.15,0.15,0.15}%
    ...
    \put(0,0){\includegraphics{./figures/parts/02/chapters/05/sections/04/orientation_errors}}%
    \gplfronttext
  \end{picture}%
\endgroup
