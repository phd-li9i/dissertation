...
\begingroup
  ...
  \begin{picture}(8000.00,8000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(7800,7483.5){\makebox(0,0)[l]{\strut{}$<e^{\overline{\delta}_{xy}, \overline{\delta}_\theta}_{\theta,\max} = 3.0181$}}%
    }%

    \put(0,0){\includegraphics{./figures/parts/02/chapters/05/sections/04/caer_style_orientation_errors_binned_dxyt6}}%
    \gplfronttext
  \end{picture}%
\endgroup
