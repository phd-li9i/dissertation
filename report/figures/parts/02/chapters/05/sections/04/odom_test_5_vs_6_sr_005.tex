...
\begin{picture}(7000.00,7000.00)%
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(-100,4300){\rotatebox{90}{\makebox(0,0)[r]{\strut{}$\sigma_R = 0.05$ m}}}%
      \put(2100,1504){\makebox(0,0){\strut{} Συχνές μετρήσεις}}
      \put(5000,1504){\makebox(0,0){\strut{} Σποραδικές μετρήσεις}}
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
    ...
    \put(0,0){\includegraphics{./figures/parts/02/chapters/05/sections/04/odom_test_5_vs_6_sr_005}}%
    \gplfronttext
  \end{picture}%
\endgroup
