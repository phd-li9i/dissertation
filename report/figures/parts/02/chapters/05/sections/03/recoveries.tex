...
\begin{picture}(8000.00,10000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.15,0.15,0.15}%
      \put(430,9520){\makebox(0,0){\color{c1} \strut{}$0$}}%
%      \colorrgb{0.15,0.15,0.15}%
      %\put(864,9520){\makebox(0,0){\color{c1} \strut{}$1$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(1648,9520){\makebox(0,0){\color{c1} \strut{}$2$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(2432,9520){\makebox(0,0){\color{c1} \strut{}$3$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(3216,9520){\makebox(0,0){\color{c1} \strut{}$4$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(4000,9520){\makebox(0,0){\color{c1} \strut{}$5$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(4783,9520){\makebox(0,0){\color{c3} \strut{}$6$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(5567,9520){\makebox(0,0){\color{c3} \strut{}$7$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(6351,9520){\makebox(0,0){\color{c3} \strut{}$8$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(7135,9520){\makebox(0,0){\color{c3} \strut{}$9$}}%
      \colorrgb{0.15,0.15,0.15}%
      \put(7570,9520){\makebox(0,0){\color{c3} \strut{}$10$}}%
    }%

    \put(0,0){\includegraphics{./figures/parts/02/chapters/05/sections/03/recoveries}}%
    \gplfronttext
  \end{picture}%
\endgroup
