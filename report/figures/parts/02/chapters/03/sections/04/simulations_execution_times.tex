...
\begingroup
  ...
  \begin{picture}(4800.00,12000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(2000,1610){\makebox(0,0){\strut{}\small $d$ [m]: Θόρυβος μέτρησης $\mathcal{N}(0.0,d)$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
    ...
    \put(0,0){\includegraphics{./figures/parts/02/chapters/03/sections/04/simulations_execution_times}}%
    \gplfronttext
  \end{picture}%
\endgroup
