...
\begingroup
  ...
  \begin{picture}(4000.00,5000.00)%
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(1002,330){\makebox(0,0){\strut{}20}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(1487,330){\makebox(0,0){\strut{}15}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(1972,330){\makebox(0,0){\strut{}10}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(2457,330){\makebox(0,0){\strut{}5}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(2942,330){\makebox(0,0){\strut{}0}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(364,2587){\rotatebox{90}{\makebox(0,0){\strut{}$x$ [m]}}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(2069,0){\makebox(0,0){\strut{}$y$ [m]}}%
      \put(2000,4850){\makebox(0,0){(γ') WAREHOUSE}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \put(0,0){\includegraphics{./figures/parts/02/chapters/03/sections/04/map_warehouse}}%
    \gplfronttext
  \end{picture}%
\endgroup
