...
\begingroup
  ...
  \begin{picture}(10000.00,4000.00)%
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(5000,4600){\makebox(0,0){\strut{}Μέσο σφάλμα εκτίμησης ανά εκτιμώμενη στάση}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(5100,-110){\makebox(0,0){\strut{}Αριθμός εκτιμήσεων στάσης στο χρόνο}}%
      ...
      \put(7690,4229){\makebox(0,0){\strut{}{\color{k}{\hdashrule[0.6mm]{0.601cm}{0.5mm}{0.5mm}}} MCL}}
      \put(7900,4000){\makebox(0,0){\strut{}{\color{k}{\rule[0.6mm]{0.5cm}{0.5mm}}} MCL $\circ$ $\circlearrowleft$}}
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
