...
\begingroup
  ...
  \begin{picture}(10000.00,4000.00)%
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      %\put(530,2069){\rotatebox{90}{\makebox(0,0){\strut{}$\overline{\|e_\theta\|_{2,i}}$, $i = \{1,2,\dots,N\}$}}}%
      \colorrgb{0.00,0.00,0.00}%
      \put(2927,-110){\makebox(0,0){\strut{}Μέθοδος ανάδρασης}}%
      \colorrgb{0.00,0.00,0.00}%
      %\put(2927,4029){\makebox(0,0){\strut{}WAREHOUSE orientation errors per feedback method}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      %\put(7422,4029){\makebox(0,0){\strut{}WAREHOUSE orientation errors per feedback method}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplfronttext
