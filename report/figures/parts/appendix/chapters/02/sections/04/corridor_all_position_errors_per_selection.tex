...
\begingroup
  ...
  \begin{picture}(10000.00,4000.00)%
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(5000,4029){\makebox(0,0){\strut{}Κατανομή σφαλμάτων εκτίμησης θέσης ανά μέθοδο επιλογής [m]}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      %\put(7422,4029){\makebox(0,0){\strut{}CORRIDOR position errors per pose selection method}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplfronttext
