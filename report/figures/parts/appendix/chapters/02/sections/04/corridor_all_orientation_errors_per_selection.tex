...
\begingroup
  ...
  \begin{picture}(10000.00,4000.00)%
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(5000,4029){\makebox(0,0){\strut{}Κατανομή σφαλμάτων εκτίμησης προανατολισμού ανά μέθοδο επιλογής [rad]}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
    ...
    \gplfronttext
    \put(0,0){\includegraphics{./figures/parts/appendix/chapters/02/sections/04/corridor_all_orientation_errors_per_selection}}%
    \gplfronttext
  \end{picture}%
\endgroup
