...
\begingroup
  ...
  \begin{picture}(4800.00,12000.00)%
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(2500,11829){\makebox(0,0){\strut{}Σφάλμα προσανατολισμού [rad]}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplgaddtomacro\gplfronttext{%
    ...
    \put(0,0){\includegraphics{./figures/parts/appendix/chapters/03/sections/04/simulations_orientation_errors}}%
    \gplfronttext
  \end{picture}%
\endgroup
