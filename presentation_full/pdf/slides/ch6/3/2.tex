\begin{frame}{Εκτίμηση προσανατολισμού όταν $\hat{\bm{l}} = \bm{l}$ (\texttt{rc\_fm}---3/3)}
  ...
  \placebottom{\tiny [1] \ \ S. Umeyama, ``Least-squares estimation of transformation parameters between two point patterns", \textit{IEEE Transactions on Pattern Analysis and Machine Intelligence}, Apr. 1991}
\end{frame}
