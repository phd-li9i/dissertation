...
if store
  img_file = strcat(pwd, '/false_oversampling_3.eps');
  drawnow ("epslatex", img_file, strcat(img_file,'.gp'));
end
...
%rectangle ("Position", [rc_zm(1), rc_zm(3), (rc_zm(2)-rc_zm(1)), (rc_zm(4)-rc_zm(3))], "Curvature", [0.0, 0.0], "EdgeColor", 'r', 'linewidth',8);

set(gca,'xtick',[])
set(gca,'ytick',[])

if store
  img_file = strcat(pwd, '/false_oversampling_4.eps');
  drawnow ("epslatex", img_file, strcat(img_file,'.gp'));
end
