...
και παράγει ένα μονοπάτι το οποίο τις συνδέει στάση χωρίς να τέμνει εμπόδια του χάρτη, \\
...
ρομπότ ώστε αυτό να κινείται πάνω στο μονοπάτι που παρήγαγε ο πρώτος αλγόριθμος. \\
Στη σχετική ορολογία ο αλγόριθμος κατασκευής μονοπατιών ονομάζεται global
planner, και ο ελεγκτής κίνησης local planner.}
