  ...
  \begin{minipage}{\linewidth}
    \begin{minipage}{0.3\linewidth}
      \begin{figure}
        ...
        \caption{\tiny Κάτοψη περιβάλλοντος και ακτίνες αισθητήρα}
      \end{figure}
    \end{minipage}
    \hfill
    \begin{minipage}{0.3\linewidth}
      \begin{figure}
        ...
        \caption{\tiny Η σάρωση στο σύστημα αναφοράς αισθητήρα}
      \end{figure}
    \end{minipage}
    \hfill
    \begin{minipage}{0.3\linewidth}
      \begin{figure}\hspace{-1cm}
        \scalebox{0.5}{\input{./figures/slides/ch4/laser.tikz}}
        \caption{\tiny Τοπικό σύστημα αναφοράς αισθητήρα}
      \end{figure}
    \end{minipage}
