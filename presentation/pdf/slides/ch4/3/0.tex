...
\note{\footnotesize Ένας δέυτερος τρόπος με τον οποίον μπορεί να ελαττωθεί το
  σφάλμα ενός παρατηρητή της στάσης ενός οχήματος που φέρει αισθητήρα lidar
  είναι μέσω ευθυγράμμισης πραγματικών με εικονικές σαρώσεις. Αυτή η μέθοδος θα
  μας ακολουθήσει σε όλη την υπόλοιπη έρευνά μου, και για λόγους οικονομίας θα
  αναφέρομαι σε αυτήν συντομογραφικά ως sm2. Η τεχνική sm2 είναι υποσύνολο της
  γενικής μεθόδου ευθυγράμμισης πραγματικών σαρώσεων, στην οποία θα αναφέρομαι
  ως σκέτο sm, εκ της φράσεως scan-matching.}
