\begin{frame}{\small Τρωτά σημεία μεθόδων ευθυγράμμισης: κενές αντιστοιχίσεις}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.45\linewidth}
      \begin{figure}
        \animategraphics[scale=0.3,autoplay]{5}{./figures/slides/ch4/sm_gif_reverse_side_by_side/icp_sigma_0/pic}{0}{50}
      \end{figure}
    \end{minipage}
    \hfill
    \begin{minipage}{0.45\linewidth}
      \begin{figure}
        \animategraphics[scale=0.3,autoplay]{5}{./figures/slides/ch4/sm_gif_reverse_side_by_side/icp_sigma_0_reverse/pic}{0}{50}
      \end{figure}
    \end{minipage}
