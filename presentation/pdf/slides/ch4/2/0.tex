...
αναφέρει ότι εάν για την εξαγωγή της εκτίμησης του φίλτρου χρησιμοποιηθεί, όχ
όλος ο πληθυσμός, αλλά ένα υποσύνολο του το οποίο περιέχει τα πιο βαρέα του
σωματιδια του, τότε αναμένουμε η εκτίμηση του φίλτρου να έχει χαμηλότερο
σφάλμα εκτίμησης.}
