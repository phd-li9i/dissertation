\begin{frame}{Πειραματική διαδικασία}
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{minipage}{0.56\linewidth}
      ...
      \begin{align}
        W_R \sim \mathcal{N}(0,\sigma_R^2 &= \{0.01^2, 0.03^2, 0.05^2, 0.10^2, 0.20^2\})  \text{ [m, m}^2\text{]} \nonumber \\
        W_M \sim \mathcal{N}(0,\sigma_{\bm{M}^2}  &= \{0.0, 0.05^2\})  \hspace{2.73cm} \text{ [m, m}^2\text{]}  \nonumber
      \end{align}
      ...
      $10 \times \sum |D_d| \times |\sigma_R| \times |\sigma_{\bm{M}}| \simeq 4.5 \cdot 10^6$\\
...
συνολικά κάθε μέθοδος κλήθηκε περίπου 4.5 εκατομμύρια φορές.
Εδώ χρησιμοποιούμε πανοραμικές σαρώσεις μεγέθους 360 ακτίνων, και θέτουμε τις
τιμές των τριών παραμέτρων που χρησιμοποιεί ο fsm2.
%Αυτό πάει να πει πως για το κομμάτι της εκτίμησης του προσανατολισμού
%υπερδειγματοληπτούμε το χάρτη κατ' ελάχιστον 2 στην δευτέρα φορές και το
%μέγιστο κατά 2 στην πέμπτη, και πως κάθε φορά που πραγματοποιείται εκτίμηση
%της θέσης, ο αριθμός των επαναλήψεων του υποσυστήματος εκτίμησης είναι
