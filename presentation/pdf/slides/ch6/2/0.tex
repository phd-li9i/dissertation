\begin{frame}{Εκτίμηση θέσης όταν $\hat{\theta} = \theta$}
  ...
  \placebottom{\tiny G. Vasiljević, D. Miklić, I. Draganjac, Z. Kovačić, P. Lista, ``High-accuracy vehicle localization for autonomous warehousing". \textit{Robotics and Computer-Integrated Manufacturing}, 2016}
