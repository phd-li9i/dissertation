\begin{frame}{Εκτίμηση θέσης όταν $\hat{\theta} = \theta$}
  ...
  \placebottom{\tiny A. Filotheou, ``Correspondenceless scan-to-map-scan matching of homoriented 2D scans for mobile robot localisation", \textit{Robotics and Autonomous Systems}, 2022}
