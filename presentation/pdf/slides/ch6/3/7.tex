...
\note{\footnotesize
Κατά τη γνώμη μου είναι ότι ο μόνος τρόπος για τη μείωση του γωνιακού σφάλματος
  χωρίς την ακούσια εισαγωγή σφαλμάτων είναι η υπερδειγματοληψία μόνο του
  χάρτη. Αυτό σημαίνει ότι αν θέλουμε να ελαττώσουμε το σφάλμα κατά 2 εις την ν
  φορές, αρκεί να υπολογίσουμε 2 εις την ν εικονικές σαρώσεις με μέγεθος ίσο με
  την πραγματική σάρωση, να ευθυγραμμίσουμε την κάθε μία με αυτήν, και να
