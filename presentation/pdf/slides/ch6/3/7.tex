...
πραγματική σάρωση, να ευθυγραμμίσουμε την κάθε μία με την πραγματική σάρωση,
και να καταλήξουμε στο ποιά από τις 2 εις την ν εκτιμήσεις εμφανίζει το
μικρότερο σφάλμα.  Οπότε τώρα εμφανίζεται μπροστά μας άλλο πρόβλημα.
Δεδομένου ενός συνόλου εκτιμήσεων στάσης οι οποίες όλες έχουν την ίδια
εκτίμηση θέσης αλλά διαφορετικές εκτιμήσεις προσανατολισμού, ποιά απο αυτές
εμφανίζει το χαμηλότερο σφάλμα προσανατολισμού?}
