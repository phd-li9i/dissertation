\begin{frame}{Μετά το \texttt{sm2} τι;}
  ...
  \begin{minipage}{\linewidth}
    \begin{figure}\centering
      ...
      \begin{textblock}{14}(3.35,5.35)
        $\rightarrow \mathcal{S}_R(\bm{p})$
      \end{textblock}
      \begin{textblock}{14}(3.4,6.1)
        $\bigl\} \mathcal{S}_V(\hat{\bm{p}}_0)$
      \end{textblock}
      \begin{textblock}{14}(3.7,6.9)
  ...
  \begin{minipage}{\linewidth}
    ...
    \begin{itemize}
      ...
      \item $\mathcal{S}_V(\hat{\bm{p}}_0) \text{ τοπική προσέγγιση } \bm{M}$ \vspace{-0.1cm}
      \item[] στη γειτονιά της $\bm{p}, \ \forall \hat{\bm{p}}_i, i = 0,1,\dots,N$
            \makebox(0,0){\put(0,4.5\normalbaselineskip){$\left.\rule{0pt}{1.8\normalbaselineskip}\right\}$
