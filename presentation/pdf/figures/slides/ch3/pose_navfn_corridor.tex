...
\begingroup
  ...
  \begin{picture}(4000.00,3200.00)%
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(4400,3700){\makebox(0,0){\strut{}Μέσο σφάλμα κατάστασης $[(\text{m}^2 + \text{rad}^2)^{1/2}]$}}%
      \put(2200,3200){\makebox(0,0){\strut{}CORRIDOR}}%
      \put(4400,-200){\makebox(0,0){\strut{}Αριθμός εκτιμήσεων στάσης στο χρόνο}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \put(0,0){\includegraphics[scale=0.8]{./figures/slides/ch3/pose_navfn_corridor}}%
    \gplfronttext
  \end{picture}%
\endgroup
