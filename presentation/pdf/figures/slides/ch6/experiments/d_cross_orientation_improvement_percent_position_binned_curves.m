...
if exist('/media/li9i/var2/elements/PhD/fourier_scan_to_map_scan_matcher/struct/scripts_phd/experiments/improvement_percent/d_cross_data/final_minus_initial_error') == 2
  mats_exist = true;
end

if (~mats_exist)
  disp('run c_.m and d_.m first and copy matrices to d_cross_data')
else
  load('/media/li9i/var2/elements/PhD/fourier_scan_to_map_scan_matcher/struct/scripts_phd/experiments/improvement_percent/d_cross_data/final_minus_initial_error');
  load('/media/li9i/var2/elements/PhD/fourier_scan_to_map_scan_matcher/struct/scripts_phd/experiments/improvement_percent/d_cross_data/initial_position_errors_comb');
end
...
set(gca(), "ytick", ytick_, "yticklabel", {'\\small $90\\%$', '\\small $95\\%$', '\\small $100\\%$'});
...
if store
  img_file = strcat(print_dir, '/cross_orientation_improvement_percent_position_binned_curves.eps');
