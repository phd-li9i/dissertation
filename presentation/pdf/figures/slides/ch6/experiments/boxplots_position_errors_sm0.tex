...
\begin{picture}(9600.00,4000.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(4799,5200){\makebox(0,0){\strut{}Κατανομές σφαλμάτων θέσης [m]}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.15,0.15,0.15}%
...
%      \colorrgb{0.15,0.15,0.15}%
      %\put(1728,2000){\makebox(0,0){\strut{}\footnotesize $0.01$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(3264,2000){\makebox(0,0){\strut{}\footnotesize $0.03$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(4800,2000){\makebox(0,0){\strut{}\footnotesize $0.05$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(6335,2000){\makebox(0,0){\strut{}\footnotesize $0.10$}}%
      %\colorrgb{0.15,0.15,0.15}%
      %\put(7871,2000){\makebox(0,0){\strut{}\footnotesize $0.20$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \colorrgb{0.15,0.15,0.15}%
